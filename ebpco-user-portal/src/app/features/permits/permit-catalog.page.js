...
import { PERMIT_TYPE_GROUPS } from '../../core/domain/permit.model';
...
let PermitCatalogPage = class PermitCatalogPage {
    formAsset = permitFormAssetFor;
    permitVisual = permitVisual;
    businesses = inject(BusinessStore);
    router = inject(Router);
    groups = PERMIT_TYPE_GROUPS;
    catalog = REQUIREMENTS_CATALOG;
