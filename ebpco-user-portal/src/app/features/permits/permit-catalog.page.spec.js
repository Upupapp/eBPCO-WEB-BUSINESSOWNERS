 ...
 */
const ALL_TYPES = PERMIT_TYPE_GROUPS.flatMap((g) => g.types);
describe('Permit form assets (F-13: bundled forms must be reachable)', () => {
    ...
    it('renders a working download link once a permit\'s requirements are open', () => {
        ...
        const type = ALL_TYPES.find((t) => !permitFormAssetFor(t).fileName.includes('unified-application-form'));
        expect(type).toBeTruthy();
        fixture.componentInstance.toggle(type);
        fixture.detectChanges();
