...
const FILTERS = ['All', 'Draft', 'Submitted', 'Under Review', 'Payment Verification', 'Approved', 'Ready for Release', 'Rejected'];
let MyApplicationsPage = class MyApplicationsPage {
