...
import { INQUIRY_TURNAROUND, MUNICIPAL_ENGINEER, MUNICIPAL_HALL_ADDRESS, PLANNING_AND_DEVELOPMENT, } from '../../core/domain/lgu-contact';
import { PRIVACY_POLICY_TEXT } from '../../core/domain/legal-copy';
let HelpSupportPage = class HelpSupportPage {
    open = signal(null);
    offices = [MUNICIPAL_ENGINEER, PLANNING_AND_DEVELOPMENT];
    engineer = MUNICIPAL_ENGINEER;
    hallAddress = MUNICIPAL_HALL_ADDRESS;
    turnaround = INQUIRY_TURNAROUND;
    faqs = [
