import { buildRectification, rectificationProblem, heldValue, POSTAL_CODE, MOBILE_NUMBER, } from './citizen-profile';
...
describe('Building a rectification', () => {
    ...
    it('does not send a clear for a field that was already not recorded', () => {
        const blank = { ...held, middleName: null, street: null };
...
describe('The recorded /me bytes', () => {
    const meApplicant = CONTRACT_SAMPLES['me.applicant'].body;
    const meRectify = CONTRACT_SAMPLES['me.rectify'].body;
