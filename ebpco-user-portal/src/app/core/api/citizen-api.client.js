 ...
 */
let CitizenApiClient = class CitizenApiClient {
     ...
     */
    getPermit(applicationId) {
        return this.get(`/applications/${encodeURIComponent(applicationId)}/permit`);
    }
    /**
    ...
    getApplication(applicationId) {
        return this.get(`/applications/${encodeURIComponent(applicationId)}`);
    }
    /**
    ...
    getTimeline(applicationId) {
        return this.get(`/applications/${encodeURIComponent(applicationId)}/timeline`);
    }
    /**
    ...
    getPayments(applicationId) {
        return this.get(`/applications/${encodeURIComponent(applicationId)}/payments`);
    }
    /**
    ...
    getDocumentContent(documentId) {
        return this.get(`/documents/${encodeURIComponent(documentId)}/content`);
    }
    /**
    ...
    getRequirements(applicationId) {
        return this.get(`/applications/${encodeURIComponent(applicationId)}/requirements`);
    }
    /**
    ...
    patchMe(patch) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        return this.http
            .patch(`${this.baseUrl}/me`, patch)
    ...
    listDocuments(applicationId) {
        return this.get(`/applications/${encodeURIComponent(applicationId)}/documents`);
    }
    /**
     ...
     */
    resubmitDocument(applicationId, documentId, body, idempotencyKey) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        const url = `${this.baseUrl}/applications/${encodeURIComponent(applicationId)}` +
            `/documents/${encodeURIComponent(documentId)}/resubmit`;
        return this.http
            .post(url, body, { headers: { 'Idempotency-Key': idempotencyKey } })
            .pipe(catchError((e) => throwError(() => this.toApiError(e))));
    }
    /**
     ...
     */
    fileApplication(body, idempotencyKey) {
        return this.post('/applications', body, idempotencyKey);
    }
    /**
     ...
     */
    submitPayment(applicationId, body, idempotencyKey) {
        return this.post(`/applications/${encodeURIComponent(applicationId)}/payments`, body, idempotencyKey);
    }
    /**
     ...
     */
    cancelApplication(applicationId, body, idempotencyKey) {
        return this.post(`/applications/${encodeURIComponent(applicationId)}/cancel`, body, idempotencyKey);
    }
    /**
    ...
    uploadDocument(body) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        return this.http
            .post(`${this.baseUrl}/documents`, body)
            .pipe(catchError((e) => throwError(() => this.toApiError(e))));
    }
    /**
    ...
    registerBusiness(body) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        return this.http
            .post(`${this.baseUrl}/businesses`, body)
            .pipe(catchError((e) => throwError(() => this.toApiError(e))));
    }
    ...
    markNotificationRead(notificationId) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        return this.http
            .post(`${this.baseUrl}/notifications/${encodeURIComponent(notificationId)}/read`, {})
            .pipe(catchError((e) => throwError(() => this.toApiError(e))));
    }
    get(path) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        return this.http.get(`${this.baseUrl}${path}`).pipe(catchError((e) => throwError(() => this.toApiError(e))));
    }
    post(path, body, idempotencyKey) {
        if (this.baseUrl === null)
            return throwError(() => new ApiNotConfiguredError());
        return this.http
            .post(`${this.baseUrl}${path}`, body, { headers: { 'Idempotency-Key': idempotencyKey } })
            .pipe(catchError((e) => throwError(() => this.toApiError(e))));
    }
    toApiError(e) {
...
CitizenApiClient = __decorate([
    Injectable({ providedIn: 'root' })
], CitizenApiClient);
export { CitizenApiClient };
/**
 ...
 */
export function isOverResubmitLimit(file, limit) {
